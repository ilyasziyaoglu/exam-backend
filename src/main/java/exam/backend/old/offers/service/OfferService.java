package exam.backend.old.offers.service;
...
import exam.backend.old.offers.db.mapper.OfferMapper;
import exam.backend.old.catalog.service.product.DistributorService;
...
import exam.backend.old.offers.db.repository.OfferHistoryRepository;
import exam.backend.old.offers.db.repository.OfferQuery;
import exam.backend.old.offers.db.repository.OfferRepository;
